...
$(function() {
	...
	var movie = {
 			...
 			$.getJSON('${context}/movie/Movie.do?page=movie_name&filmNumber='+data.filmNumber, 
					function(data) {
						var movieInfom = '<h1>무비페이지</h1>'
							...
							+'<div id="movie_cut" class="movie_cut_lay movie_margin_b20"><h2>스틸컷<a href="#"><input type="button" value="스틸컷 더보기" id="cutmore" class="movie_bold movie_bg_color_green movie_txt_color_white "></a></h2>'
							+'<div class="movie_cut movie_margin_l30  movie_float"><a href="#"><img src="../images/'+data.filmNumber+'1.jpg;" alt="" width="290" height="161" /></a></div>'
							+'<div class="movie_cut movie_margin_l20 movie_float"><a href="#"><img src="../images/'+data.filmNumber+'2.jpg;" alt="" width="290" height="161" /></a></div>'
							+'<div class="movie_cut movie_margin_l20 movie_float"><a href="#"><img src="../images/'+data.filmNumber+'3.jpg;" alt="" width="290" height="161" /></a></div>'
							+'<div class="movie_cut movie_margin_l20 movie_float"><a href="#"><img src="../images/'+data.filmNumber+'4.jpg;" alt="" width="290" height="161" /></a></div></div>'
							
						$('#movie_wrap').empty().html(movieInfom).append(movie.trailer(data));
						...
						$('#cutmore').click(function() {
							movie.movieBasic(data);
						});
					});
		},
		trailer : function(data) {
			$.getJSON('${context}/movie/Movie.do?page=movie_Tra&filmNumber='+data.filmNumber, function(data) {
			...
			$.getJSON('${context}/movie/Movie.do?page=movie_Cut&filmNumber='+data.filmNumber, function(data) {
				...
				$.each(data, function(index, value) {
					movieCut += '<div class="cut_allcut cut_margin_l30 cut_margin_t20 cut_margin_b20  cut_float"><a href="../images/'+value+'.jpg;">'
						+'<img src="../images/'+value+'.jpg;" alt="" width="290" height="161" /></a></div>';
		...
		movieBasic : function(data) {
			$.getJSON('${context}/movie/Movie.do?page=movie_Basic&filmNumber='+data.filmNumber, function(data) {
				    var movieBasic ='<div><h1>영화상세<a href="#"><input type="button" value="영화정보" id="movie_home" class="cut_bold cut_bg_color_orange cut_txt_color_white "></a></h1></div>'
				...
				$('#movie_wrap').empty().html(movieBasic).append(movie.cutMore(data));
